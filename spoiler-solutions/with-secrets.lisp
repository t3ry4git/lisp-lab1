...
(setq include-in-two '(a 2 1) list-two (list include-in-two 'b (rest include-in-two) 'c))
(print list-two)
(format t "~%SECRET V3")
...
(setq include-in-four '(a) list-four (list (cons 1 include-in-four) (cons 2 include-in-four) (cons 3 include-in-four) 'c))
(print list-four)
(format t "~%SECRET V5")
(defvar list-five nil)
(defvar include-in-five nil)
(setq include-in-five '(4 e f) list-five (list* 'd include-in-five  (list 5) (last include-in-five)))
(print list-five)
(format t "~%SECRET V7")
(defvar list-seven nil)
(defvar include-in-seven nil)
(setq include-in-seven '(d e f) list-seven (list include-in-seven (rest include-in-seven) (list 'f) 4))
(print list-seven)
(format t "~%SECRET V8")
(defvar list-eight nil)
(defvar include-in-eight nil)
(setq include-in-eight '(d) list-eight (list (list 4 include-in-eight 5) 'e 'f (cons 6 include-in-eight)))
(print list-eight)