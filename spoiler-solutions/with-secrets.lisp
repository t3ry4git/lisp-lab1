...
(setq include-in-three '(3 c b) list-three (list 1 'a (car (last include-in-three)) include-in-three))
(print list-three)
(format t "~%SECRET V4")
...
(setq include-in-seven '(d e f) list-seven (list include-in-seven (rest include-in-seven) 'f 4))
(print list-seven)
(format t "~%SECRET V8")
(defvar list-eight nil)
(defvar include-in-eight nil)
(setq include-in-eight 'd list-eight (list (list 4 include-in-eight 5) 'e 'f (list 6 include-in-eight)))
(print list-eight)